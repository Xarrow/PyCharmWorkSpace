...
这里ip使用服务器的ip，端口默认50050，用户名随意，密码为之前设置的密码，然后connect,弹出验证窗口，然后点是，就进入CobaltStrike了。
...
![Alt text](http://static.wooyun.org//drops/20151108/20151108071456166871446823044303.png)
